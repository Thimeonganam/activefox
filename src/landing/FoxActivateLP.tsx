...
import { ShieldCheck, Dumbbell, Award, HelpCircle, ArrowRight, Zap, Target, Flame, HeartPulse, CheckCircle2, UserCheck } from "lucide-react";
...
export default function FoxActivateLP() {
  ...
  return (
    <div ref={containerRef} className="w-full bg-white text-neutral-900 font-sans selection:bg-brand-orange selection:text-white pt-20 overflow-hidden">
      ...
      {/* ─── 1. HERO SECTION ─── */}
      <section className="relative w-full min-h-[95vh] flex items-center justify-center py-16 md:py-24 overflow-hidden border-b border-neutral-100 bg-gradient-to-b from-[#fffcfb] to-white">
        {/* Glow Effects */}
        <div className="absolute top-1/4 left-1/4 w-[350px] h-[350px] bg-brand-orange/[0.03] rounded-full blur-[120px] pointer-events-none"></div>
        <div className="absolute bottom-1/4 right-1/4 w-[450px] h-[450px] bg-[#bd7a58]/[0.03] rounded-full blur-[150px] pointer-events-none"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-[#fff3ec] border border-brand-orange/10 text-brand-orange text-[9px] md:text-[10px] font-monument tracking-[0.25em] uppercase rounded-full mb-8 self-start shadow-[0_4px_12px_rgba(255,97,41,0.05)]">
              <span className="w-1.5 h-1.5 bg-brand-orange rounded-full animate-ping"></span>
              FOX ACTIVATE - GIẢI PHÁP TẬP LUYỆN TOÀN DIỆN
            </div>

            <h1 className="text-4xl md:text-6xl lg:text-7.5xl font-monument uppercase tracking-tight leading-[1.0] mb-8 text-neutral-950">
            ...
            <p className="text-neutral-600 text-sm md:text-base leading-relaxed mb-10 max-w-xl font-light">
            ...
            {/* Spec list cards */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 border-t border-neutral-100 pt-8 max-w-2xl">
              <div className="bg-neutral-50 border border-neutral-200/40 p-4 rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
                <span className="text-[9px] font-monument tracking-widest text-neutral-400 uppercase block mb-1">01 THÁNG</span>
                <span className="text-xs font-monument uppercase text-neutral-900 font-bold">Tập Gym Tự Do</span>
              </div>
              <div className="bg-neutral-50 border border-neutral-200/40 p-4 rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
                <span className="text-[9px] font-monument tracking-widest text-neutral-400 uppercase block mb-1">01 BUỔI</span>
                <span className="text-xs font-monument uppercase text-neutral-900 font-bold">Sports Massage 60p</span>
              </div>
              <div className="bg-neutral-50 border border-neutral-200/40 p-4 rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
                <span className="text-[9px] font-monument tracking-widest text-neutral-400 uppercase block mb-1">01 BUỔI</span>
                <span className="text-xs font-monument uppercase text-neutral-900 font-bold">Coaching 1:1</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 w-full" id="booking-form">
            <div className="relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-brand-orange to-[#bd7a58] rounded-[32px] blur-xl opacity-10 pointer-events-none"></div>
              {/* Form will style correctly based on page context */}
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16 lp-fade">
          ...
          <h2 className="text-3xl md:text-5xl font-monument uppercase tracking-tighter leading-tight text-neutral-950 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Pillar 1 */}
          <div className="bg-neutral-50/50 border border-neutral-200/60 p-8 rounded-3xl flex flex-col justify-between hover:border-brand-orange/30 hover:shadow-lg transition-all duration-300 lp-fade">
            <div>
              <div className="w-12 h-12 bg-brand-orange/5 border border-brand-orange/10 rounded-2xl flex items-center justify-center mb-6 text-brand-orange">
                <Dumbbell className="w-6 h-6" />
              </div>
              <span className="text-xs font-monument tracking-wider text-neutral-400 uppercase block mb-2">PILLAR 01 / TẬP LUYỆN</span>
              <h3 className="text-xl font-monument uppercase text-neutral-950 mb-4">1 THÁNG TẬP GYM KHÔNG GIỚI HẠN</h3>
              <p className="text-neutral-600 text-xs md:text-sm leading-relaxed font-light mb-6">
            ...
            <ul className="space-y-2 border-t border-neutral-200/40 pt-6 text-xs text-neutral-700 font-light">
          ...
          <div className="bg-neutral-50/50 border border-neutral-200/60 p-8 rounded-3xl flex flex-col justify-between hover:border-brand-orange/30 hover:shadow-lg transition-all duration-300 lp-fade">
            <div>
              <div className="w-12 h-12 bg-[#bd7a58]/5 border border-[#bd7a58]/10 rounded-2xl flex items-center justify-center mb-6 text-[#bd7a58]">
                <UserCheck className="w-6 h-6" />
              </div>
              <span className="text-xs font-monument tracking-wider text-neutral-400 uppercase block mb-2">PILLAR 02 / HƯỚNG DẪN</span>
              <h3 className="text-xl font-monument uppercase text-neutral-950 mb-4">1 BUỔI COACHING 1:1 CÙNG HLV</h3>
              <p className="text-neutral-600 text-xs md:text-sm leading-relaxed font-light mb-6">
          ...
          <div className="bg-neutral-50/50 border border-neutral-200/60 p-8 rounded-3xl flex flex-col justify-between hover:border-brand-orange/30 hover:shadow-lg transition-all duration-300 lp-fade">
            <div>
              <div className="w-12 h-12 bg-neutral-200/20 border border-neutral-300/30 rounded-2xl flex items-center justify-center mb-6 text-neutral-700">
                <HeartPulse className="w-6 h-6" />
              </div>
              <span className="text-xs font-monument tracking-wider text-neutral-400 uppercase block mb-2">PILLAR 03 / PHỤC HỒI</span>
              <h3 className="text-xl font-monument uppercase text-neutral-950 mb-4">1 BUỔI SPORTS MASSAGE 60 PHÚT</h3>
              <p className="text-neutral-600 text-xs md:text-sm leading-relaxed font-light mb-6">
      ...
      <section className="py-24 bg-neutral-50 border-y border-neutral-100">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-6 lp-fade">
            ...
            <h2 className="text-3xl md:text-5xl font-monument uppercase tracking-tighter leading-tight text-neutral-950 mb-8">
            ...
            <button 
              ...
              className="px-8 py-4 bg-brand-orange hover:bg-[#e04f1a] text-white font-monument text-xs uppercase tracking-wider rounded-full transition-colors flex items-center gap-2 shadow-lg shadow-brand-orange/20"
            >
          ...
          <div className="lg:col-span-6 space-y-4 lp-fade">
            <div className="bg-white border border-neutral-200/60 p-6 rounded-2xl flex items-center justify-between shadow-[0_2px_10px_rgba(0,0,0,0.01)]">
              <div>
                <span className="text-[10px] font-monument tracking-wider text-neutral-400 uppercase block mb-1">MUA RIÊNG LẺ THÔNG THƯỜNG</span>
                <span className="text-neutral-500 text-xs font-light">1 tháng tập + 1 buổi Coach + 1 buổi Massage</span>
              </div>
              <span className="text-lg font-monument text-neutral-400 line-through">1.300.000đ</span>
            </div>

            <div className="bg-white border-2 border-brand-orange/20 p-8 rounded-3xl flex flex-col justify-between relative overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.04)]">
              <div className="absolute top-0 right-0 bg-brand-orange text-white font-monument text-[9px] tracking-widest uppercase px-4 py-1.5 rounded-bl-2xl">
                TIẾT KIỆM 54%
              </div>
              ...
              <h3 className="text-2xl font-monument uppercase text-neutral-950 mb-4">CHỈ 599.000Đ / THÁNG</h3>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-16 lp-fade">
          ...
          <h2 className="text-3xl md:text-4xl font-monument uppercase tracking-tighter leading-tight text-neutral-950 mb-6">
            KHÔNG GIAN LÀM NÊN KẾT QUẢ
          </h2>
          <p className="text-neutral-600 text-xs md:text-sm font-light">
      ...
      <section className="py-24 max-w-4xl mx-auto px-6 lp-fade">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-monument uppercase tracking-tighter leading-tight text-neutral-950">
        ...
        <div className="space-y-4">
          {faqs.map((faq, idx) => {
            ...
            return (
              <div 
                key={idx} 
                className="bg-neutral-50/50 border border-neutral-200/60 rounded-2xl overflow-hidden transition-all duration-300"
              >
                <button
                  onClick={() => toggleFaq(idx)}
                  className="w-full px-6 py-5 text-left flex items-center justify-between font-monument text-xs md:text-sm uppercase tracking-wide text-neutral-800 hover:text-brand-orange transition-colors"
                >
                  <span>{faq.q}</span>
                ...
                >
                  <p className="text-neutral-600 text-xs md:text-sm leading-relaxed font-light border-t border-neutral-100 pt-4">
                    {faq.a}
                  </p>
                </div>
              </div>
